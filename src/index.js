    ...
    const vm = new Vue({
        ...
        methods: {
                ...
                getRandomMsg(dialog.details)
                    .forEach(content => {
                        this.msgChain = this.msgChain
                            .then(() => delay(700))
                            .then(() => this.sendMsg(content, AUTHOR.ANKIT));
                    });

                return dialog.nextAnkit
                    ? this.appendDialog(dialog.nextAnkit)
                    : this.msgChain.then(() => {
                        this.lastDialog = dialog;
                        this.isAnkitTyping = false;
                    });
            },
            ...
            getDialog(id) {
                ...
                const dialogs = this.dialogs.fromAnkit
            ...
            togglePrompt(toShow) {
                if (this.isAnkitTyping) {
                    // don't prompt if Ankit is typing
                    return;
                }
            ...
            respond(response) {
                ...
                return this.say(response.content, response.nextAnkit);
            },
            ...
            ask(fromUser) {
                ...
                return this.say(content, fromUser.nextAnkit);
            },
